...
We capture this by relating history extension to outcome refinement:
under history extension, observable outcomes evolve \emph{upward} in the outcome
...
Faithful modeling amounts to choosing $(\Poss,\Ord,\Obs)$ so that observable
...
partition, agreement mechanisms that control observability, and related
