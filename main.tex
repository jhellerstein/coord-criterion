...
among declarative logic programs, the monotone programs are exactly those
that admit coordination-free distributed evaluation.
To instantiate CALM in our framework we use transducer executions as histories,
logic programs as specifications, and output \emph{sets} as observations.
Formal definitions
and a full proof appear in Appendix~\ref{app:calm-formal}, but the mapping is direct:
in monotone logic programs, additional input facts (events) produce more output facts
(observations).
