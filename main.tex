...
The observability function $\Obs(H)$ captures which outcomes the specification
treats as correct at history $H$ itself.
This separation allows us to reason explicitly about the relationship between
future behaviors and present commitments.
As we show below, coordination arises from how observable commitments interact
with the space of admissible causal extensions.
