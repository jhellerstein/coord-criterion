...
connects coordination-freedom to monotonicity in declarative distributed programs
\cite{hellerstein2010calm,ameloot2013relational,li2025coordinationfree}.
Our formulation shares this goal of a boundary theorem, but gives the
first semantically minimal account defined directly over Lamport histories in a
standard asynchronous model.
This makes the criterion directly applicable to classical PODC objects, tasks,
and consistency conditions without recasting them into a specific programming or
replicated-object formalism (Section~\ref{sec:applications}).
Further discussion of related semantic formulations appears in
