...
\begin{abstract}
  ...
  This \emph{Coordination Criterion} is stated directly over Lamport
  histories—partially ordered executions under happens-before—and specification-defined observable outcomes,
  without assuming any particular programming
  ...
  snapshot tasks, transactional isolation levels, and invariant confluence—all
  instances of the same underlying semantic phenomenon.
\end{abstract}
...
\paragraph{CALM Generalizations.}
