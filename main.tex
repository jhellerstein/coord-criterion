...
\paragraph{$\SpecIt$ sketch.}
Histories consist of read and write \emph{events} on a single logical register,
with real-time order induced by invocation and response events.
Outcomes are sequences of completed read and write events annotated with return
values.
